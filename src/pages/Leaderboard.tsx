  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <div className="glass-panel rounded-3xl overflow-hidden border border-slate-700/50">
        <div className="bg-slate-900/80 p-4 grid grid-cols-12 gap-4 text-xs font-bold uppercase tracking-widest text-slate-500 border-b border-slate-700 min-w-[500px]">
        ...
        <div className="divide-y divide-slate-800/50 overflow-x-auto">
                  ...
                  >
                    ...
                    <div className="col-span-6 flex items-center gap-3">
                      ...
                      <div className="truncate">
                        <div className={`font-bold truncate ${user.isCurrentUser ? 'text-purple-300' : 'text-slate-200'}`}>
